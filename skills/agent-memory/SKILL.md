...
`.agent-memory.toml` is not part of the binding. Manage memory files through
`agent-memory`; do not create, inspect, edit, or reorganize memory directories by hand.
