...
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| IOB-001 `vault init`      | TEST-001 runs `iwe2 vault init <vault>` and checks Git repository status, the IWE config, and root/global graph indexes. Commit `af6db4b` added the red graph-link proof; commit `e0a57a8` made it green.                       | A CLI that creates directories but omits Git versioning or IWE graph inclusion links fails verification.                                    |
