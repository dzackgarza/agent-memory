...
- Do not build a database, embedding store, reranker, parser, backlink engine, or MCP server.
- Do not make `zk`, Probe, or vector search part of the MVP runtime. The transcript marks these as optional complements; `rg` is enough to prove scoped body search.
